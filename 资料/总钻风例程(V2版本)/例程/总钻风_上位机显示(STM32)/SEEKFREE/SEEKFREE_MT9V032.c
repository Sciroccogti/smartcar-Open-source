...
void mt9v032_init(void)
{
    ...
    usart2_init(42,9600);		//初始化串口2波特率为9600
...
{
	put_char(USART1,0x00);put_char(USART1,0xff);put_char(USART1,0x01);put_char(USART1,0x01);//发送命令
    uart_putbuff(USART1, (uint8_t *)image, ROW*COL);  //发送图像
}
